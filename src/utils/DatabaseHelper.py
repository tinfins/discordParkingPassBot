...
class DatabaseHelper:
    ...
    def create_table_sql(self, conn):
        ...
        """
        sql = f"CREATE TABLE IF NOT EXISTS {self.table_name} (pass_id integer PRIMARY KEY, name text, date text, " \
              f"out int NOT NULL);"
    ...
    def add_pass(self, conn, pass_num, out_bool):
        ...
        :param out_bool: Boolean: 1 checked out, 0 checked in
        :return:var:True if success, else False
        """
    ...
    def setup(self, guild):
        ...
        if db_exists is False:
            sqlite_h.create_database(db_path)
